...
|---|---|---|
| **SCOM Management Pack** | Committed platform track | Version 1.0.0.0 permanently sealed, offline verified, and repository-published; operator SCOM certification follows installation |
