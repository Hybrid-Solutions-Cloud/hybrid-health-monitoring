...
2. **[Download the release](/downloads/hyper-v-private-cloud)**: Download the sealed production 12-pack bundle (`Hyper-V-Private-Cloud-Monitoring-Deployment-1.3.6.0.zip`).
