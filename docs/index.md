...
graph TD
    ...
    subgraph HVTrack["Hyper-V Sovereign SCOM Health Model"]
        HV --> HVS["Enterprise SCOM Management Pack Suite (v1.3.6.0)"]
...
|---|---|---|---|
| **Hyper-V Private Cloud (Flagship)** | SCOM Management Pack Suite | **Production Release (1.3.6.0)** | "Private Cloud Powered by Hyper-V: A 360° View" — 100% on-premises SCOM (2019 / 2022 / 2025), PowerShell 7+, zero cloud dependency |
...
Hyper-V Private Cloud Monitoring `1.3.6.0` is the current sealed production release ("Private Cloud Powered by Hyper-V: A 360° View") and is available from
