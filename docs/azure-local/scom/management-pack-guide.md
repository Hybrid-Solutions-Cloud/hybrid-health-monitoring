...
No Azure Local SCOM package is publicly downloadable yet. The source remains a development and
validation baseline and must not be treated as a production release.
