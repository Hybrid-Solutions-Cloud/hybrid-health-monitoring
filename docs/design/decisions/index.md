...
| Hyper-V platform and SCOM | Accepted ADRs 0022, 0025–0029, 0031, and 0040–0047 for product boundary, network authority, DA, object/discovery, health/DA, authoring toolchain, external ownership, Pure Storage, SOFS/networking, v2 packaging, Network ATC, SDN, VMM, and explicit PowerShell 7 execution; ADR 0040 supersedes 0039 and ADR 0043 supersedes 0027 for v2 |
