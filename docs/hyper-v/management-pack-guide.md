...
upgraded, and removed. Version `1.1.0.0` is permanently sealed with public key token
...
**[Download version 1.1.0.0 now](../downloads/hyper-v-private-cloud.md).** Import exactly one
...
The product version and token above are the facts for release `1.1.0.0`; confirm them against the
...
contains the 66 import-ready XML files generated for product `1.1.0.0` and token
`54d0fb1159995c86`.
